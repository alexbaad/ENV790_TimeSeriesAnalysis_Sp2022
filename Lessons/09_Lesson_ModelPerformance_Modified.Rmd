---
title: "M9: Forecast Accuracy - Modified"
author: "Luana Lima"
date: "03/21/2022"
output: pdf_document
...
This part of the code was changed to access forecast accuracy. 
...
SARIMA_for <- forecast::forecast(SARIMA_autofit,h=12)
...
```{r}
#Create a data frame where first column is observed and the other columns correspond to forecast for each of the three models.
Last12 <- data.frame(cbind(observed,MEAN_seas$mean,SNAIVE_seas$mean,SARIMA_for$mean))

#Use ggplot to show observed and forecast on a single plot.
